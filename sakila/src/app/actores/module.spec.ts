...
import { Actor, ActoresDAOService, ActoresViewModelService } from './servicios.service';
...
describe('Modulo Actores', () => {
  ...
  describe('DAOService', () => {
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        providers: [ActoresDAOService, HttpClient],
      });
    });
    ...
    it('add', inject([ActoresDAOService, HttpTestingController], (dao: ActoresDAOService, httpMock: HttpTestingController) => {
      const item = {...dataAddMock} as Actor;
    ...
    it('change', inject([ActoresDAOService, HttpTestingController], (dao: ActoresDAOService, httpMock: HttpTestingController) => {
      const item = { ...dataEditMock } as Actor;
  ...
  describe('ViewModelService', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        providers: [NotificationService, LoggerService,
          {
            provide: ActoresDAOService, useFactory: () => new DAOServiceMock<Actor, number>([...dataMock])
          }
        ],
      });
    ...
    describe('mode', () => {
      ...
      it('add', () => {
        service.add()
        expect(service.Elemento).withContext('Verify Elemento').toEqual(new Actor())
      ...
      describe(componente.name, () => {
        ...
        beforeEach(async () => {
          await TestBed.configureTestingModule({
                providers: [NotificationService, LoggerService, ActoresViewModelService],
        ...
        beforeEach(() => {
          const vm = TestBed.inject(ActoresViewModelService)
          vm.add()
